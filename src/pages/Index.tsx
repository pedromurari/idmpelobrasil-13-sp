          ...
          <div className="text-center mb-8 animate-fade-in">
            <h1 className="hero-headline">
              <span className="headline-line highlight text-center text-2xl md:text-4xl">
                IDM Pelo Brasil Numerologia: Uma experiencia presencial em Sao
                Paulo para quem quer aprender, vivenciar e aplicar a numerologia
                com clareza.
              </span>
            </h1>
            ...
            <div className="text-lg md:text-xl text-muted-foreground space-y-2 max-w-3xl mx-auto">
              <div className="bg-card/50 border-2 border-primary/40 rounded-xl p-4 mt-4 mb-4">
                <p className="text-primary font-bold text-xl mb-2">
                  2 TURMAS DISPONIVEIS - 04 de Abril em Pinheiros SP!
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <FAQItem
                ...
                answer="A experiencia sera realizada no dia 04/04 (Sabado), com duas turmas: Manha (09h as 12h) e Tarde (14h as 17h), presencial em Pinheiros, Sao Paulo - Rua Oscar Freire, 2617 cj 408. As informacoes detalhadas serao enviadas imediatamente apos sua inscricao, por WhatsApp e email."
              />
              <FAQItem
                value="faq-5"
