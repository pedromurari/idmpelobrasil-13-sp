      ...
      <section className="py-6 md:py-8 px-4 relative z-10">
        <div className="section-container">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <FAQItem value="faq-4" question="Quando e onde será o curso?" answer="O curso será realizado no dia 13/12 (Sábado) das 09h às 12h, presencial no Centro do Rio de Janeiro (endereço exato a confirmar). As informações detalhadas do local serão enviadas imediatamente após sua inscrição, por WhatsApp e email." />
